...
Generated by `tools/Build-PfbValueEnumMap.ps1` against `Data/PfbValueEnumMap.json` (28 REST versions, 305 entries).
...
| `Public/Array/Get-PfbArrayPerformance.ps1:28` | `-Protocol` | nfs, smb, http, s3 |  | **collision** | matches 6 distinct (schema, property) entries with different value sets: GET arrays/performance#protocol; GET file-systems/performance#protocol; FileLock.protocol; FileSession.protocol; Protocol; Protocol_clients |
